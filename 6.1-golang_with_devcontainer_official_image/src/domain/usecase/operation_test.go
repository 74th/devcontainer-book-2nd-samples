...
import (
	...
	"github.com/74th/devcontainer-book-2nd-samples/6.1-golang_with_devcontainer_official_image/src/domain/usecase"
	"github.com/74th/devcontainer-book-2nd-samples/6.1-golang_with_devcontainer_official_image/src/memdb"
)
